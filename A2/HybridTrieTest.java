...
// 		interface TrieNodeInt [ supplied to you ]
...
public class HybridTrieTest
{
	public static void main(String [] args) throws IOException
	{
		...
		// code / algorithms in your HybridTrieST class should be mostly
		// independent of the node implementation.  This is why the TrieNodeInt
		// interface is being used to represent the nodes.  However, the actual
		// nodes must be of some class (since an interface is abstract) and the
		// treeType argument indicates how they will be generated.  For more
